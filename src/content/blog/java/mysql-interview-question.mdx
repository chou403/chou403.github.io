...
![image-20230703165807448](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703165807448.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/859ab55da7e84b9da3ec34cd4ca9d611.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/4f4a765331f84efda30d2ae165f45707.png)

##### 记录头信息

记录头信息部分如下图所示:

![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/d35c888d876641768d782acb0e6668d3.png)

![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/9fac7f2392674842aba39dc969dfa126.png)

![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/aef632ad1be7455ab7e23909f68255f1.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/ae0a8a7826e4429683f2c12de76760a1.png)
...
![image-20230703174800471](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703174800471.png)

最大最小记录不是自己定义的记录,所以它们并不存放在页的User Records 部分,而是被单独放在一个称为Infimum + Supremum 的部分,如图所示:

![image-20230703174836315](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703174836315.png)
...
![image-20230703175113161](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703175113161.png)
...
![image-20230703175303142](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703175303142.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/e3ed90eaaf7747c49acfc2c59225a1d2.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/05aa65d74e8e4f1481eb7409fca14f96.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/285d9c00300a45af94c31b74e5a9df19.png)
...
![image-20230703181623066](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703181623066.png)
...
![image-20230703181828283](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230703181828283.png)
...
![InnoDB architecture diagram showing in-memory and on-disk structures.](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/innodb-architecture-5-7.png)
...
![image-20230904181941928](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/image-20230904181941928.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/v2-7ba7ee9eb267c9d62e95c3e858419e32_1440w.png)

现在有个编号为 20 的页被预读了,这个页只会被插入到 old 区域头部,而 old 区域末尾的页(10号)会被淘汰掉。

![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/v2-b381ae4b18804701b12cad3b770167b2_1440w.png)

如果 20 号页一直不会被访问,它也没有占用到 young 区域的位置,而且还会比 young 区域的数据更早被淘汰出去。

如果 20 号页被预读后,立刻被访问了,那么就会将它插入到 young 区域的头部,young 区域末尾的页(7号),会被挤到 old 区域,作为 old 区域的头部,这个过程并不会有页被淘汰。

![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/v2-73eeea4b1a6b0e6f0553b3ef07e36e4a_1440w.png)
...
![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/v2-ce159c31ecabe38c68bb35cfce35e410_1440w.png)

在批量访问这些页的时候,会被逐一插入到 young 区域头部。

![img](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/v2-1c75fa046988f1a9774fb258d73cba6f_1440w.png)
...
![image-20230905135508966](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230905135508966.png)
...
![image-20230905151907748](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/image-20230905151907748.png)
...
![image-20230905152906765](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230905152906765.png)
...
![image-20230918172052198](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230918172052198.png)
...
![image-20230921175115312](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230921175115312.png)
...
2. InnoDB 缓存性能评估
   ...
   - 以下公式计算 InnoDB BufferPool 命中率:
     ...
     ![image-20230922112638300](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230922112638300.png)
...
3. Page 管理相关参数
   ...
   ![image-20230922113121486](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230922113121486.png)

   Page 页管理状态相关参数

   ![image-20230922113235811](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230922113235811.png)
...
1. 日志缓冲区相关参数配置
   ...
   - **Innodb_log_buffer_size 缓冲区大小**
     ...
     ![image-20230922114800080](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230922114800080.png)

   - **innodb_log_files_in_group 日志组文件个数**

     日志组根据需要来创建。而日志组的成员则需要至少 2 个,实现循环写入并作为冗余策略。

     ![image-20230922114934551](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230922114934551.png)
   ...
   - **Innodb_log_file_size 日志文件大小**
     ...
     ![image-20230922115422562](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20230922115422562.png)
...
![image-20231017153855797](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231017153855797.png)
...
2. **Compact 行记录格式**
   ...
   **记录额外信息部分**
   ...
   ![image-20231018103232216](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018103232216.png)
...
3. **Compact 中的行溢出机制**
   ...
   **Compact 中的行溢出机制**
   ...
   ![image-20231018105842012](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018105842012.png)
...
2. **Index Nested-Loop Join(索引嵌套循环连接)**
   ...
   - 当 order 表的 user_id 为索引的时候执行过程如下:
     ...
     ![image-20231018113134392](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018113134392.png)
...
3. **Block Nested-Loop Join(块嵌套循环连接)**
   ...
   ![image-20231018114043166](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018114043166.png)
...
![image-20231018145644074](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018145644074.png)
...
1. 原子性
   ...
   ![image-20231018154446991](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018154446991.png)
...
4. 持久性
   ...
   - 当数据发生修改时,InnoDB 不仅会修改 Buffer Pool 中的数据,也会在 redo log buffer 记录这次操作;当事务提交时,会对 redo log buffer 进行刷盘,记录到 redo log file 中。如果 MySQL 宕机,重启时可以读取 redo log file 中的数据,对数据库进行恢复。这样就不需要每次提交事务都实时进行刷脏了。
     ...
     ![image-20231018171335505](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231018171335505.png)
...
![image-20231019170022564](https://cdn.jsdelivr.net/gh/chou403/pic-md@main/img/image-20231019170022564.png)
